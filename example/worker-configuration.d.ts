/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ccff9cdb679477a5e57ea90b4cfe2a32)
// Runtime types generated with workerd@1.20251202.0 2025-12-09 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'MONGO_DURABLE_OBJECT';
	}
	interface Env {
		MONGO_URI: string;
		MONGO_DB: string;
		MONGO_DURABLE_OBJECT: DurableObjectNamespace /* MONGO_DURABLE_OBJECT */;
	}
}
